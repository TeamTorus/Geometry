...
CMD_ID = f'{config.COMPANY_NAME}_{config.ADDIN_NAME}_VP1304Builder'
CMD_NAME = 'VP1304 Builder'
...
def command_execute(args: adsk.core.CommandEventArgs):
    ...
    #need to add a check if the loft fails
    ...
    prop.bodies.item(0).name = fileInBoxID.text
